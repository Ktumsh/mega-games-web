...
function aplicarEstilos() {
  if (window.matchMedia("(max-width: 576px)").matches) {
    ...
    saleSectionGrid6.style.gridTemplateColumns = "repeat(2, minmax(0px, 1fr))";

    //panel5
    saleSectionGrid8.style.gridTemplateColumns = "repeat(2, minmax(0px, 1fr))";
    ...
    //panel4
    saleSectionGrid6.style.gridTemplateColumns = "repeat(3, minmax(0px, 1fr))";
    ...
    //panel4
    saleSectionGrid6.appendChild(lastCard5);
    saleSectionGrid6.style.gridTemplateColumns = "repeat(4, minmax(0px, 1fr))";

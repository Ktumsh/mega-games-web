        ...
        if (juego) {
          ...
          if (
            ...
            precioHTML = `
                <div class="discount_block discount_block_inline">
                  ...
                  <div class="discount_prices">
                    <div class="discount_original_price">${juego.precioOriginal}</div>
                    <div class="discount_final_price">${juego.precioDescuento}</div>
                  </div>
                </div>
              `;
          } else {
            precioHTML = `
                <div class="discount_block no_discount discount_block_inline">
                  <div class="discount_prices">
                    <div class="discount_final_price">${juego.precio}</div>
                  </div>
                </div>
              `;
          }
          const juegoHTML = `
            ...
            juego.id
                ...
                <div
                  class="capsule main_capsule"
                  style="background-image: url(${juego.imagenAlternativa});"
                ></div>
                <div class="info">
                  <div class="app_name">
          ...
          carruselContainer.innerHTML += juegoHTML;
        }
      });
    })

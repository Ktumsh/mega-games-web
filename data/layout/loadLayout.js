      ...
      footerContainer.innerHTML = `
        <footer id="footer" class="pt-5">
          <div class="row container justify-content-between">
            ...
            <div class="d-flex justify-content-md-end col-6 col-md-2 px-0">
          ...
          <div class="d-flex flex-column flex-sm-row justify-content-between align-items-center pt-4 mt-4 border-top fs-sm opacity-75">
            <p class="opacity-75 mb-4">© 2024 Mega Games Store. Página creada con fines didácticos e inspirada en Steam y Eneba. No tiene relación oficial con estas marcas. Las imágenes utilizadas son para prácticas educativas. Nombres y marcas mencionados son propiedad de sus respectivos dueños.
            <a class="text-decoration-none text-white fw-medium footer_link2 mb-4 me-1" href="#">Términos y condiciones</a>
            |
            <a class="text-decoration-none text-white fw-medium footer_link2 mb-4 ms-1 me-1" href="#">Aviso de privacidad</a>
            |
            <a class="text-decoration-none text-white fw-medium footer_link2 mb-4 ms-1" href="#">Reembolsos</a>
            </p>
...
document.getElementById("installAppFooter")?.addEventListener("click", () => {
  if (defPrompt) {
    defPrompt.prompt();
    defPrompt = null;
  }

              ...
              <div class="card_struct active border-p3">
                <div class="card_content">
                  ...
                  <div class="card_bottom_body">
                    <a class="card_link" href="/offer-details.html?game=${pageName}&item=${tarjeta.id}">
            ...
            cardContent = `
              <div class="card_struct active">
                <div class="card_content">
                  ...
                  <div class="card_bottom_body">
                    <a class="card_link" href="/games-details.html?game=${pageName}&item=${tarjeta.id}">
            ...
            cardContent = `
              <div class="card_struct card_struct_2 active">
                <div class="card_content">
                  ...
                  <div class="card_bottom_body">
                    <a class="card_link" href="/gift-details.html?game=${pageName}&item=${tarjeta.id}">
                      <div class="card_price">
                        <span class="card_text">Desde</span>
                        <span class="price">CLP$ ${tarjeta.precioOriginal}</span>
                      </div>
